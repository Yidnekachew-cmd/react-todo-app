...
["Todo App"] :- "Todo App" is a Single Page App (SPA) website that allows users to:

- Add todo tasks.
- Delete the completed tasks.
- To edit the listied tasks.
...
```sh
cd my-folder
git clone https://github.com/Yidnekachew-cmd/react-todo-app.git
```
### Install
...
Feel free to check the [issues page](https://github.com/Yidnekachew-cmd/react-todo-app/issues).
